...
public class RecipesuiipManager extends GeneratedRecipesuiipManager
{
	...
	private static final Logger LOG = LoggerFactory.getLogger(RecipesuiipManager.class);
	...
	{
		return (RecipesuiipManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(RecipesuiipConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		LOG.debug("init() of RecipesuiipManager called, current tenant: {}", getTenant().getTenantID());
	}
