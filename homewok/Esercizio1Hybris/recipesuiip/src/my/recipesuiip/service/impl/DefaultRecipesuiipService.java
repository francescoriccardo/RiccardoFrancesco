...
public class DefaultRecipesuiipService implements RecipesuiipService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultRecipesuiipService.class);
	...
	{
		return DefaultRecipesuiipService.class.getResourceAsStream("/recipesuiip/sap-hybris-platform.png");
	}
