...
public class DefaultStageraceuiipService implements StageraceuiipService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultStageraceuiipService.class);
	...
	{
		return DefaultStageraceuiipService.class.getResourceAsStream("/stageraceuiip/sap-hybris-platform.png");
	}
