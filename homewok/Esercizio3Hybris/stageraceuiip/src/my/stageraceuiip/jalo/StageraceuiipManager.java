...
/**
 * This is the extension manager of the Stageraceuiip extension.
 */
public class StageraceuiipManager extends GeneratedStageraceuiipManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(StageraceuiipManager.class);
	 ...
	 */
	public static StageraceuiipManager getInstance()
	{
		return (StageraceuiipManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(StageraceuiipConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public StageraceuiipManager() // NOPMD 
	{
		LOG.debug("constructor of StageraceuiipManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of StageraceuiipManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of StageraceuiipManager called, current tenant: {}", getTenant().getTenantID());
	}
