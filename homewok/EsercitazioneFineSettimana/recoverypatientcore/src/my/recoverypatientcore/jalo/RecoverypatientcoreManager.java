...
/**
 * This is the extension manager of the Recoverypatientcore extension.
 */
public class RecoverypatientcoreManager extends GeneratedRecoverypatientcoreManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(RecoverypatientcoreManager.class);
	 ...
	 */
	public static RecoverypatientcoreManager getInstance()
	{
		return (RecoverypatientcoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(RecoverypatientcoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public RecoverypatientcoreManager() // NOPMD 
	{
		LOG.debug("constructor of RecoverypatientcoreManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of RecoverypatientcoreManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of RecoverypatientcoreManager called, current tenant: {}", getTenant().getTenantID());
	}
