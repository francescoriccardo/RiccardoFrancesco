...
public class DefaultRecoverypatientcoreService implements RecoverypatientcoreService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultRecoverypatientcoreService.class);
	...
	{
		return DefaultRecoverypatientcoreService.class.getResourceAsStream("/recoverypatientcore/sap-hybris-platform.png");
	}
